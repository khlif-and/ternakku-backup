...
namespace App\Services\Web\Report\QurbanSalesLivestock\Services;
...
class QurbanSalesLivestockReportService
{
    ...
    public function generateReport($farmId, array $filters)
    {
        ...
        return QurbanSalesLivestockReportResource::collection($data);
    }
