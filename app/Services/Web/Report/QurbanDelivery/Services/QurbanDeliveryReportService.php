...
namespace App\Services\Web\Report\QurbanDelivery\Services;
...
class QurbanDeliveryReportService
{
    public function getQuery($farmId, array $filters)
    {
        // Replicating logic from DeliveryInstructionService::getDeliveryInstructions
        $query = QurbanDeliveryInstructionH::query()
            ->with(['driver', 'fleet', 'qurbanDeliveryInstructionD.qurbanDeliveryOrderH'])
    ...
    public function generateReport($farmId, array $filters)
    {
        ...
        return QurbanDeliveryReportResource::collection($data);
    }
}
