...
namespace App\Services\Web\Report\QurbanDetailedDelivery\Controllers;
...
class QurbanDetailedDeliveryReportController extends Controller
{
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('livewire.reports.qurban.detailed-delivery-report.pdf', [
            'data' => $data,
            'farm' => $farm,
        ...
        return $pdf->download('laporan-detail-pengiriman-hewan-qurban-' . Carbon::now()->format('YmdHis') . '.pdf');
    }
}
