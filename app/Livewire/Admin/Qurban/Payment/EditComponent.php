...
class EditComponent extends Component
{
    ...
    protected function rules()
    {
        return [
            ...
            'qurban_customer_id' => 'required', // Modified rule
            'livestock_id' => 'required', // Modified rule
    ...
    public function updatedQurbanCustomerId($value)
    {
        ...
        if ($value) {
            $this->livestocks = QurbanSaleLivestockD::whereHas('qurbanSaleLivestockH', function ($q) use ($value) {
                $q->where('qurban_customer_id', $value);
            })->with('livestock')->get()->pluck('livestock', 'livestock_id');
        }
    }
    ...
    {
        return view('livewire.admin.qurban.payment.edit-component');
    }
}
