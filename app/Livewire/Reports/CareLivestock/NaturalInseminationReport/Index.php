...
namespace App\Livewire\Reports\CareLivestock\NaturalInseminationReport;
...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        $transformedCollection = $data->getCollection()->map(function ($item) {
            return (new NaturalInseminationReportResource($item))->resolve();
        });
        $data->setCollection($transformedCollection);

        return view('livewire.reports.care-livestock.natural-insemination-report.index', [
            'data' => $data,
            'farm' => $this->farm,
        ])
