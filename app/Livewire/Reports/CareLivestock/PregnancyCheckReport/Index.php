...
namespace App\Livewire\Reports\CareLivestock\PregnancyCheckReport;
...
use App\Services\Web\Report\PregnancyCheck\Resources\PregnancyCheckReportResource;
use Carbon\Carbon;
...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        $transformedCollection = $data->getCollection()->map(function ($item) {
            return (new PregnancyCheckReportResource($item))->resolve();
        });
        $data->setCollection($transformedCollection);

        return view('livewire.reports.care-livestock.pregnancy-check-report.index', [
            'data' => $data,
        ])
