...
namespace App\Livewire\Reports\CareLivestock\QurbanSalesLivestock;
...
use App\Services\Web\Report\QurbanSalesLivestock\Resources\QurbanSalesLivestockReportResource;
use Carbon\Carbon;
...
class Index extends Component
{
    ...
    {
        $service = new QurbanSalesLivestockReportService();
        ...
        if ($this->showReport) {
            ...
            $transformedCollection = $data->getCollection()->map(function ($item) {
                return (new QurbanSalesLivestockReportResource($item))->resolve();
            });
        ...
        return view('livewire.reports.care-livestock.qurban-sales-livestock.index', [
            'data' => $data,
            'summary' => $summary,
            'farm' => $this->farm,
        ])
