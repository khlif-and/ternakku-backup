...
namespace App\Livewire\Reports\CareLivestock\TreatmentIndividuReport;

use Livewire\Component;
use Livewire\WithPagination;
use App\Models\Farm;
use App\Services\Web\Report\TreatmentIndividu\Controllers\TreatmentIndividuReportController;
...
class Index extends Component
{
    ...
    {
        $service = new TreatmentIndividuReportService();
        $controller = new TreatmentIndividuReportController($service);
        ...
        if ($this->showReport) {
            ...
            if ($data instanceof \Illuminate\Pagination\LengthAwarePaginator) {
                $transformedCollection = $data->getCollection()->map(function ($item) {
                    return (new \App\Services\Web\Report\TreatmentIndividu\Resources\TreatmentIndividuReportResource($item))->resolve();
                });
        ...
        return view('livewire.reports.care-livestock.treatment-individu-report.index', [
            'pens' => $this->farm->pens,
