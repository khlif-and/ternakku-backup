...
namespace App\Livewire\Reports\Qurban\CancelationReport;
...
class Index extends Component
{
    ...
    public function boot(QurbanCancelationReportService $service)
    {
    ...
    public function render()
    {
        ...
        $view = request()->routeIs('qurban.*')
            ? 'livewire.reports.qurban.cancelation-report.index'
            : 'livewire.reports.qurban.cancelation-report.index';
