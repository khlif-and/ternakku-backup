...
use App\Http\Resources\Qurban\SavingRegistrationUserListResource;

class SavingRegistrationDetailResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'users' => SavingRegistrationUserListResource::collection($this->qurbanSavingRegistrationUser),
        ];
    }
}
