...
class ContractStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'province_id' => 'required|exists:provinces,id|size:2',
            'regency_id' => 'required|exists:regencies,id|size:4',
            'district_id' => 'required|exists:districts,id|size:7',
            'village_id' => 'required|exists:villages,id|size:10',
