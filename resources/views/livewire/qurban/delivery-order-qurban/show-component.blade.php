    ...
    <div class="bg-white rounded-lg shadow-sm border">
        <div class="px-6 py-4 border-b flex justify-between items-center bg-gray-50">
            ...
            <div class="flex gap-2">
                <x-button.action href="{{ route('admin.qurban.delivery_order_qurban.edit', $delivery->id) }}"
                    color="blue">
                    Edit
                </x-button.action>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t flex justify-end">
            <x-button.link href="{{ route('admin.qurban.delivery_order_qurban.index') }}" color="gray">
                Kembali
            </x-button.link>
        </div>
    </div>
