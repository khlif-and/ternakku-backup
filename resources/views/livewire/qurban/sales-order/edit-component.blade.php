    ...
    <form wire:submit.prevent="update" class="space-y-6">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between border-b pb-2">
                ...
                <button type="button" wire:click="addItem" class="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    + Tambah Hewan
                </button>
            </div>
        ...
        <div class="flex justify-end gap-3 pt-4 border-t">
            <a href="{{ route('admin.care-livestock.sales-order.index', $farm->id) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Batal
            </a>
