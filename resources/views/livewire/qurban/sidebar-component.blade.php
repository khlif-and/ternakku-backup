<aside
    class="sidebar text-white relative z-30 {{ $sidebarCollapsed ? 'closed' : '' }}"
    wire:key="qurban-sidebar"
>
        ...
        <ul class="space-y-5">
            ...
            <li>
                <button wire:click="toggleDataAwal" type="button"
                    ...
                    <svg class="w-4 h-4 transition-transform {{ $dataAwalOpen ? 'rotate-180' : '' }}" fill="none" stroke="currentColor"
            ...
            <li>
                <button wire:click="toggleAktivitas" type="button"
                    ...
                    <svg class="w-4 h-4 transition-transform {{ $aktivitasOpen ? 'rotate-180' : '' }}" fill="none" stroke="currentColor"
                        stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
            ...
            <li>
                <button wire:click="toggleLaporan" type="button"
                    ...
                    <svg class="w-4 h-4 transition-transform {{ $laporanOpen ? 'rotate-180' : '' }}" fill="none" stroke="currentColor"
                        stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
