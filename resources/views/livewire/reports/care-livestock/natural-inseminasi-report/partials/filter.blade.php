<div class="bg-white rounded-xl shadow-sm border p-6 mb-6">
    <h2 class="text-lg font-bold text-gray-800 mb-4">Filter Laporan Inseminasi Alami</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
           <x-form.select 
                ...
                :options="$livestocks->mapWithKeys(fn($l) => [$l->id => ($l->eartag ?? $l->code) . ' - ' . ($l->livestockType->name ?? '')])->toArray()"
            />
        </div>
