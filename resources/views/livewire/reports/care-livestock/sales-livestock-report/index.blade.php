@section('title', 'Laporan Penjualan Ternak')

<div>
    <x-admin.feature-card title="Laporan Penjualan Ternak" :breadcrumbs="[
        ['label' => 'Care Livestock', 'route' => 'admin.care-livestock.index'],
        ['label' => 'Laporan', 'route' => ''],
        ['label' => 'Penjualan Ternak', 'route' => ''],
    ]">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Laporan ini menampilkan daftar transaksi penjualan ternak (Qurban Sales).
                        </p>
                    </div>
                </div>
            </div>
