@section('title', 'Laporan Produksi Susu Global')

<div>
    <x-admin.feature-card title="Laporan Produksi Susu Global" :breadcrumbs="[
        ['label' => 'Care Livestock', 'route' => 'admin.care-livestock.index'],
        ['label' => 'Laporan', 'route' => ''],
        ['label' => 'Produksi Susu Global', 'route' => ''],
    ]">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Laporan ini menampilkan rekapitulasi produksi susu harian (Pagi & Sore).
                        </p>
                    </div>
                </div>
            </div>
