<div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
        <h3 class="text-lg font-semibold text-gray-800">Riwayat Inseminasi Buatan</h3>
        <div class="flex space-x-2">
            <a href="{{ route('admin.care-livestock.artificial-inseminasi-report.export-pdf', ['farm_id' => $farm->id] + request()->query()) }}"
                target="_blank"
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Petugas
                    </th>
                    <th scope="col"
                ...
                @forelse($data as $item)
                    <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                            {{ $item['semen_breed_name'] }} (Batch: {{ $item['semen_batch'] }})
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-10 text-center text-gray-500">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-base font-medium text-gray-900">Tidak ada data inseminasi ditemukan</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
