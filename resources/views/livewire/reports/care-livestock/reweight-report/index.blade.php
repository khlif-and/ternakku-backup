@section('title', 'Laporan Timbang Ulang')

<div>
    <x-admin.feature-card title="Laporan Timbang Ulang" :breadcrumbs="[
        ['label' => 'Care Livestock', 'route' => 'admin.care-livestock.index'],
        ['label' => 'Laporan', 'route' => ''],
        ['label' => 'Timbang Ulang', 'route' => ''],
    ]">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Laporan ini menampilkan riwayat penimbangan ulang ternak untuk memantau perkembangan bobot.
                        </p>
                    </div>
                </div>
            </div>
