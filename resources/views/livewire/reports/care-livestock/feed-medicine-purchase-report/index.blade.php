@section('title', 'Laporan Pembelian Pakan & Obat')

<div>
    <x-admin.feature-card title="Laporan Pembelian Pakan & Obat" :breadcrumbs="[
        ['label' => 'Care Livestock', 'route' => 'admin.care-livestock.index'],
        ['label' => 'Laporan', 'route' => ''],
        ['label' => 'Pembelian Pakan & Obat', 'route' => ''],
    ]">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Laporan ini menampilkan riwayat pembelian pakan (hijauan/konsentrat) dan obat-obatan.
                        </p>
                    </div>
                </div>
            </div>
