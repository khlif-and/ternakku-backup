    ...
    <form wire:submit.prevent="save" class="w-full">
        <div class="mb-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <select wire:model="livestock_id" class="w-full px-4 py-3 border rounded-lg text-base focus:ring-blue-500 focus:border-blue-500" required>
            ...
            <div>
                ...
                <select wire:model="disease_id" class="w-full px-4 py-3 border rounded-lg text-base focus:ring-blue-500 focus:border-blue-500" required>
