<div>
    ...
    <form wire:submit.prevent="save" class="w-full">
        <div class="mb-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <label class="block mb-2 text-base font-semibold text-gray-700">Pilih Ternak (Betina) <span
        ...
        <x-form.footer backRoute="{{ route('admin.care-livestock.milk-production-individu.index', $farm->id) }}"
