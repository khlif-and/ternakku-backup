...
<x-header.admin-header :user="auth()->user()">
    ...
    <button @click="logoutModal = true; open = false" type="button" 
            class="flex items-center w-full px-3 py-2 text-left text-sm font-medium text-red-600 rounded-lg hover:bg-red-50 transition-colors">
