...
>
    ...
    <nav class="px-2 text-sm">
        <ul class="space-y-1">
            <!-- PELIHARA TERNAK -->
            <li>
                <button @click="peliharaOpen = !peliharaOpen" type="button"
                    ...
                    <svg :class="{ 'rotate-180': peliharaOpen }" class="w-4 h-4 arrow-icon" fill="none"
                        stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
                <div x-show="peliharaOpen" x-transition
            ...
            <!-- KOLONI TERNAK -->
            <li>
                <button @click="koloniOpen = !koloniOpen" type="button"
                    class="w-full flex items-center justify-between px-4 py-2 font-medium hover:bg-white/10 transition">
                    <span class="sidebar-label">Koloni Ternak</span>
                    <svg :class="{ 'rotate-180': koloniOpen }" class="w-4 h-4 arrow-icon" fill="none"
                        stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
