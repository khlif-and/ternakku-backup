<x-sidebar.menu-group name="laporanAktivitasOpen" label="Laporan Aktivitas">
    ...
    <x-sidebar.menu-link :href="route('admin.care-livestock.reweight-report.index', ['farm_id' => $farm->id])" label="Laporan Timbang Ulang" />
    <x-sidebar.menu-link :href="route('admin.care-livestock.pregnant-check-report.index', ['farm_id' => $farm->id])" label="Laporan Cek Kehamilan" />
    <x-sidebar.menu-link :href="route('admin.care-livestock.birth-report.index', ['farm_id' => $farm->id])" label="Laporan Kelahiran" />
    <x-sidebar.menu-link :href="route('admin.care-livestock.sales-order-report.index', ['farm_id' => $farm->id])" label="Laporan Sales Order" />
    <x-sidebar.menu-link :href="route('admin.care-livestock.customer-report.index', ['farm_id' => $farm->id])" label="Laporan Pelanggan" />
