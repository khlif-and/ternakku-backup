    ...
    <div class="p-6">
        <div class="mb-6">
            ...
            <ul class="flex items-center text-sm space-x-2 text-gray-500 mb-4">
                ...
                <li><i class="icon-arrow-right"></i></li>
                <li><a href="{{ route('admin.care-livestock.livestock-reception.index', $farm->id) }}" class="hover:text-blue-600">Registrasi Ternak</a></li>
                <li><i class="icon-arrow-right"></i></li>
                <li>Edit</li>
            </ul>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden w-full transition-all duration-300">
            ...
            <div class="px-16 py-8">
                @livewire('admin.livestock-reception.edit-component', ['farm' => $farm, 'reception' => $reception])
            </div>
        </div>
    </div>
@endsection
