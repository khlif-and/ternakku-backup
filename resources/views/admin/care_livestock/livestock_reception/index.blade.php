...
<div class="p-6">
    <div class="mb-6">
        <p class="text-gray-700 text-lg mb-3 font-semibold">[ Data Registrasi Ternak ]</p>
    </div>
    ...
    <div id="livestock-list-container"
        ...
        @include('admin.care_livestock.livestock_reception.partials.tabel')
        {{-- Pastikan path 'partials._livestock-reception-table' sesuai dengan lokasi file Anda --}}
