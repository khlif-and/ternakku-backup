...
@section('content')
    <div class="p-6 sm:p-8">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-700">Tambah Pembelian Pakan / Obat</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 sm:p-10">
            @include('admin.care_livestock.feed_medicine_purchase.partials.form')
        </div>
    </div>
@endsection
...
@section('script')
    ...
    {{-- Alpine.js (jika perlu dropdown modern) --}}
    <script src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js" defer></script>

    <script>
        // Init datepicker untuk tanggal pembelian
