...
@section('content')
    <div class="p-6 sm:p-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-800">
                    {{-- Judul bisa dibuat dinamis untuk create/edit --}}
                    {{ isset($milkProductionIndividu) ? 'Edit' : 'Tambah' }} Produksi Susu Individu
                </h1>
            ...
            <div class="mt-4 sm:mt-0">
                {{-- DIUBAH: Nama route dan parameter disesuaikan --}}
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 sm:p-10">
            @include('admin.care_livestock.milk_production_individu.partials.form')
        </div>
    </div>
@endsection

@section('script')
    {{-- AirDatepicker untuk input tanggal --}}
