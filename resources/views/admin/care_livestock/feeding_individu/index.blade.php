...
<div class="p-6">
    <div class="mb-6">
        <p class="text-gray-700 text-lg mb-3 font-semibold">[ Pemberian Pakan Individu ]</p>
    </div>

    <div id="feeding-individu-list-container"
        ...
        @include('admin.care_livestock.feeding_individu.partials.tabel')
...
<script>
    $(document).ready(function () {
        setTimeout(function () {
            $('#feeding-individu-list-container').removeClass('opacity-0 translate-y-4')
