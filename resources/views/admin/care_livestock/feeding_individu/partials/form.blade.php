...
<form action="{{ route('admin.care-livestock.feeding-individu.store', ['farm_id' => $farm->id]) }}" method="POST" class="w-full max-w-full">
    @csrf
            ...
            <select id="livestock_id" name="livestock_id"
                ...
                @foreach ($livestocks as $livestock)
                    @php
                        ...
                        // Label dropdown: EARTAG - NAMA (JENIS - RAS)
    ...
    {{-- Baris 2: Ringkasan ternak (readonly) --}}
    <div class="grid md:grid-cols-2 md:gap-6">
        <div class="mb-8">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between mb-3">
            <label class="block text-sm font-semibold text-gray-800">Daftar Bahan Pakan</label>
...
<script>
    // Sync eartag / nama / jenis / ras ketika select berubah
    (function () {
        ...
        if (sel.value) sync(); // prefill saat reload
    })();
