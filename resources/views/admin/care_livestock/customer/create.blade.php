...
@section('content')
    ...
    <div class="p-6 sm:p-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-700">Tambah Customer</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="mt-4 sm:mt-0">
                <a href="{{ route('admin.care-livestock.customer.index', ['farm_id' => $farmId]) }}"
                   class="inline-flex items-center gap-2 bg-white border border-gray-300 hover:bg-gray-100
                          text-gray-800 font-semibold rounded-lg px-4 py-2 text-sm transition-all duration-300 shadow-sm">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 sm:p-10">
            @include('admin.care_livestock.customer.partials.form')
        </div>
...
@section('script')
{{-- Kalau butuh datepicker atau alpine.js tinggal tambah di sini --}}
@endsection
