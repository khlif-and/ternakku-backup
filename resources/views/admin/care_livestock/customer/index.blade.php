...
<div class="p-6">
    {{-- Title --}}
    <div class="mb-6">
        <p class="text-gray-700 text-lg mb-3 font-semibold">[ Customer ]</p>
    </div>
    ...
    <div id="customer-list-container"
        ...
        {{-- Panggil partial tabel Customer --}}
        @include('admin.care_livestock.customer.partials.tabel')
        {{-- Pastikan file partial berada di:
             resources/views/admin/care_livestock/customer/partials/tabel.blade.php --}}
    </div>
</div>
@endsection
