...
<div class="flex flex-col sm:flex-row items-center justify-between px-8 py-4 gap-4">
    <div>
        <h1 class="text-xl font-bold text-gray-800">Produksi Susu Global</h1>
        <p class="mt-1 text-sm text-gray-500">Daftar semua data Produksi Susu Global ternak di peternakan.</p>
    </div>
    <div class="flex-shrink-0">
        <a href="{{ route('admin.care-livestock.milk-production-global.create', $farm->id) }}"
...
{{-- Filter Tanggal --}}
<div class="px-8 py-4">
    <form method="GET" action="{{ route('admin.care-livestock.milk-production-global.index', $farm->id) }}"
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-4 py-4 text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="{{ route('admin.care-livestock.milk-production-global.edit', [$farm->id, $item->id]) }}"
                                        ...
                                        <form
                                            action="{{ route('admin.care-livestock.milk-production-global.destroy', [$farm->id, $item->id]) }}"
                                            method="POST"
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center py-10 text-gray-500">
                                    Belum ada data produksi susu global.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
