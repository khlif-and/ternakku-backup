...
<div class="p-6">
    <div class="mb-6">
        {{-- DIUBAH: Judul disesuaikan untuk Livestock Classification --}}
        <p class="text-gray-700 text-lg mb-3 font-semibold">[ Klasifikasi Ternak ]</p>
    </div>
    ...
    <div id="livestock-list-container"
        ...
        {{-- DIUBAH: Path partial disesuaikan untuk classification --}}
        @include('admin.care_livestock.classification.partials.table')
