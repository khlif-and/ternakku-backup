...
@section('content')
    ...
    <div class="p-6 sm:p-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">
                    Tambah Jadwal Treatment Individu
                </h1>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-700">Tambah Jadwal Treatment Individu</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 sm:p-10">
            {{-- Form untuk jadwal treatment individu --}}
            @include('admin.care_livestock.treatment_schedule_individu.partials.form')
        </div>
    </div>
@endsection
...
@section('script')
    ...
    <script>
        // Inisialisasi datepicker untuk tanggal transaksi dan (jika ada) tanggal jadwal
        const tx = document.querySelector('#transaction-date-airdatepicker');
        if (tx) {
            new AirDatepicker(tx, { autoClose: true, dateFormat: 'yyyy-MM-dd' });
        }
        const sch = document.querySelector('#schedule-date-airdatepicker');
        if (sch) {
            new AirDatepicker(sch, { autoClose: true, dateFormat: 'yyyy-MM-dd' });
        }
    </script>
@endsection
