    ...
    <div class="p-6 sm:p-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-700">Tambah Natural Insemination</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="mt-4 sm:mt-0">
                <a href="{{ route('admin.care_livestock.natural_insemination.index', ['farm_id' => $farmId]) }}"
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 sm:p-10">
            @include('admin.care_livestock.natural_insemination.partials.form')
        </div>
    </div>
@endsection

@section('script')
    {{-- Hanya Alpine, tanpa AirDatepicker --}}
