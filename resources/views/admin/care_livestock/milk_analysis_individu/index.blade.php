...
<div class="p-6">
    <div class="mb-6">
        {{-- Judul diubah menjadi Analisis Susu Individu --}}
        <p class="text-gray-700 text-lg mb-3 font-semibold">[ Analisis Susu Individu ]</p>
    </div>
    ...
    <div id="livestock-list-container"
        ...
        {{-- Path partial diubah ke folder milk_analysis_individu --}}
        @include('admin.care_livestock.milk_analysis_individu.partials.tabel')
