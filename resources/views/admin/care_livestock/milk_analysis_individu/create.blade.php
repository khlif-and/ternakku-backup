...
@section('content')
    <div class="p-6 sm:p-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-800">
                    {{-- DIUBAH: Judul dibuat dinamis untuk create/edit --}}
                    {{ isset($analysis) ? 'Edit' : 'Tambah' }} Analisis Susu Individu
                </h1>
            ...
            <div class="mt-4 sm:mt-0">
                {{-- DIUBAH: Route tombol disesuaikan --}}
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 sm:p-10">
            {{-- DIUBAH: Path include disesuaikan --}}
            @include('admin.care_livestock.milk_analysis_individu.partials.form')
        </div>
    </div>
@endsection
