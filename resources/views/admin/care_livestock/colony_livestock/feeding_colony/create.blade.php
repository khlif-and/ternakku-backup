...
@section('content')
    <div class="p-6 sm:p-8">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500">Feeding Colony</span>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-700">Tambah Data</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 sm:p-10">
            {{-- Ganti path partial ke feeding_colony --}}
            @include('admin.care_livestock.colony_livestock.feeding_colony.partials.form')
        </div>
    </div>
@endsection
...
@section('script')
    ...
    <script>
        window.oldPenId = "{{ old('pen_id') ?? '' }}";
    </script>
    <script src="{{ asset('admin/feeding-colony/feeding-colony.js') }}"></script>
    <script>
