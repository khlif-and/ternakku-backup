...
@section('content')
    <div class="p-6 sm:p-8">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-700">Tambah Analisis Susu Global</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        {{-- KARTU KONTEN UTAMA: hanya membungkus formulir --}}
        <div class="bg-white rounded-2xl shadow-lg p-8 sm:p-10">
            @include('admin.care_livestock.milk_analysis_global.partials.form')
        </div>
    </div>
@endsection

@section('script')
    {{-- AirDatepicker (optional, sesuaikan id field tanggal kalau pakai JS datepicker) --}}
    ...
    <script>
        new AirDatepicker('#transaction_date', {
            autoClose: true,
