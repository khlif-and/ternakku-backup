...
<div class="flex flex-col sm:flex-row items-center justify-between px-8 py-4 gap-4">
    ...
    {{-- Tombol "Tambah" tidak ada karena klasifikasi diubah per ternak --}}
</div>
...
{{-- Filter --}}
<div class="px-8 py-4">
    {{-- DIUBAH: Filter disesuaikan untuk mencari eartag --}}
            ...
            <div class="shadow-sm overflow-hidden border-b border-gray-200 rounded-lg">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            @php
                                // DIUBAH: Header tabel disesuaikan
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        {{-- DIUBAH: Loop menggunakan variabel $livestocks --}}
                        @forelse($livestocks as $index => $livestock)
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-4 py-4 text-sm text-gray-800">
                                    {{-- ASUMSI: Ada relasi 'classification' di model Livestock --}}
                                    {{ $livestock->classification->name ?? 'Belum Diklasifikasi' }}
                                </td>
                                <td class="px-4 py-4 text-right text-sm font-medium">
                                    {{-- DIUBAH: Aksi menuju halaman edit klasifikasi --}}
