...
@section('content')
    <div class="p-6">
        <div class="mb-6">
            <p class="text-gray-700 text-lg mb-3 font-semibold">[ Data Pengiriman ]</p>
        </div>
        ...
        <div id="delivery-list-container"
            ...
            <div class="w-full flex items-center justify-end px-8 h-[90px] bg-white border-b border-gray-200">
                <a href="{{ route('cancelation_qurban.create') }}"
            ...
            <div class="overflow-x-auto mt-6 px-8 pb-8">
                <table class="w-full text-center rounded-xl border border-black border-collapse">
                    <thead>
                        <tr>
                            @foreach (['Nomor Hewan', 'Alasan Pembatalan', 'Tanggal Pembatalan', 'Aksi'] as $header)
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="py-6 pl-6 border border-black text-left">Force Majeure</td>
