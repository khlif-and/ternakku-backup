...
@section('content')
    <div class="p-6">
        <div class="mb-6">
            <p class="text-gray-700 text-lg mb-3 font-semibold">[ Daftar Harga ]</p>
        </div>
        ...
        <div id="delivery-list-container"
            ...
            <div class="w-full flex items-center justify-end px-8 h-[90px] bg-white border-b border-gray-200">
                <a href="{{ route('sales_qurban.create') }}"
            ...
            <div class="overflow-x-auto mt-6 px-8 pb-8">
                <table class="w-full text-center rounded-xl border border-black border-collapse">
                    <thead>
                        <tr>
                            @foreach (['Nama', 'Jenis Ternak', 'Berat Minimum', 'Berat Maksimum', 'Harga per Kg', 'Aksi'] as $header)
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="py-6 pl-6 border border-black text-left">Sapi</td>
                            <td class="py-6 pl-6 border border-black text-left">300 kg</td>
                            <td class="py-6 pl-6 border border-black text-left">450 kg</td>
                            <td class="py-6 pl-6 border border-black text-left">Rp 95.000</td>
                            <td class="py-6 pl-6 border border-black text-left">
                                <div class="flex space-x-2">
                                    ...
                                    <button type="button" onclick="openDeleteDeliveryModal('#')"
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            setTimeout(function () {
                $('#delivery-list-container').removeClass('opacity-0 translate-y-4')
