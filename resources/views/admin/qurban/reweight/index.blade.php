...
@section('content')
    <div class="p-6">
        <div class="mb-6">
            <p class="text-gray-700 text-lg mb-3 font-semibold">[ Data Reweight ]</p>
        </div>
        ...
        <div id="reweight-list-container"
            ...
            <div class="overflow-x-auto mt-6 px-8 pb-8">
                <table class="w-full text-center rounded-xl border border-black border-collapse">
                    <thead>
                        <tr>
                            @foreach (['Nomor Hewan', 'PBB (kg)', 'DOF (Hari)', 'ADG (kg/hari)', 'Tanggal', 'Catatan', 'Foto', 'Aksi'] as $header)
                                <th class="py-4 px-4 border border-black font-medium text-base">
                                    <div class="flex items-center justify-between w-full">
                                        <span>{{ $header }}</span>
                                        @if (!in_array($header, ['Aksi', 'Foto', 'Catatan']))
                    ...
                    <tbody>
                        <tr>
                            <td class="py-6 pl-6 border border-black text-left">001-A</td>
                            <td class="py-6 pl-6 border border-black text-left">350.5</td>
                            <td class="py-6 pl-6 border border-black text-left">120</td>
                            <td class="py-6 pl-6 border border-black text-left">1.25</td>
                            <td class="py-6 pl-6 border border-black text-left">Kamis, 8 Mei 2025</td>
                            <td class="py-6 pl-6 border border-black text-left">Keterangan singkat</td>
                            <td class="py-6 pl-6 border border-black text-left">
                                <img src="https://placehold.co/60x40" alt="Foto" class="rounded shadow w-16 h-auto mx-auto">
                            </td>
                            <td class="py-6 pl-6 border border-black text-left">
                                <div class="flex space-x-2">
                                    <a href="{{ url('reweight/1/edit') }}"
                                    ...
                                    <button type="button" onclick="openDeleteReweightModal('{{ url('reweight/1') }}')"
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between pt-4">
                    <div class="pl-2 pb-2 md:pb-0">
                        <span class="text-gray-500 text-base">Showing 1 to 1 of 1 entries</span>
                    </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 border-b-4 border-red-500 animate-fadeInUp">
                <div class="flex flex-col items-center text-center space-y-5">
                    ...
                    <p class="text-base text-gray-700 mb-2">Apakah kamu yakin ingin menghapusnya?</p>
                </div>
                <form method="POST" class="flex flex-col gap-4 mt-6">
                    ...
                    <div class="flex justify-end gap-2">
                        <button type="button" onclick="closeDeleteReweightModal()"
