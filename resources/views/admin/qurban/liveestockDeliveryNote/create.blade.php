...
<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs mb-3">
            ...
            <li class="nav-item">
                <a href="{{ url('qurban/livestock-delivery-note') }}">Surat Jalan Ternak</a>
            </li>
        </ul>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Tambah Surat Jalan Ternak</h4>
                    </div>
                </div>

<div class="card-body">
    <form action="{{ url('qurban/livestock-delivery-note') }}" method="POST">
        @csrf
