<nav id="navbar"
    ...
    <div class="flex items-center transition-all duration-500 ease-in-out px-4 md:px-8 py-4 nav-inner">
        ...
        <button @click="isOpen = !isOpen" class="ml-auto md:hidden text-2xl p-2 focus:outline-none" aria-label="Open menu">
            ...
            <svg x-show="isOpen" x-cloak xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
        ...
        <ul class="hidden md:flex flex-1 justify-center items-center space-x-8 text-base">
            <li><a href="#hero-banner" class="nav-link font-bold text-black ml-8">Beranda</a></li>
            <li><a href="#about" class="nav-link font-semibold text-gray-700 hover:text-black">Tentang Aplikasi</a></li>
            <li><a href="#features" class="nav-link font-semibold text-gray-700 hover:text-black">Fitur Kamu</a></li>
        </ul>
    ...
    <div x-show="isOpen"
        ...
        <ul class="flex flex-col space-y-3">
            <li><a href="#hero-banner" @click="isOpen = false" class="nav-link-mobile block py-2 font-bold text-black">Beranda</a></li>
            <li><a href="#about" @click="isOpen = false" class="nav-link-mobile block py-2 font-semibold text-gray-700 hover:text-black">Tentang Aplikasi</a></li>
            <li><a href="#features" @click="isOpen = false" class="nav-link-mobile block py-2 font-semibold text-gray-700 hover:text-black">Fitur Kamu</a></li>
            <li>
