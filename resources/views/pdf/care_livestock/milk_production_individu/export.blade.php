...
<head>
    ...
    <title>Laporan Produksi Susu Individu</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>Laporan Produksi Susu Individu</h1>
        ...
        <tbody>
            @if($type === 'all')
                @foreach($data as $item)
                    <tr>
                        ...
                        <td>{{ $item['livestock_name'] }} ({{ $item['livestock_code'] }})</td>
            ...
            @else
                <tr>
                    ...
                    <td>{{ $data['livestock_name'] }} ({{ $data['livestock_code'] }})</td>
